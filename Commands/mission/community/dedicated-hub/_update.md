# [Command] _mission community dedicated-hub update_
...
- DedicatedHub_CreateOrUpdate
    ```bash
        mission community dedicated-hub update --resource-group TestResourceGroup --community-name TestCommunity --dedicated-hub-name TestDedicatedHub
    ```
