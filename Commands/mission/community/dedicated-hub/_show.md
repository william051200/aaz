# [Command] _mission community dedicated-hub show_
...
- DedicatedHub_Get
    ```bash
        mission community dedicated-hub show --resource-group TestResourceGroup --community-name TestCommunity --dedicated-hub-name TestDedicatedHub
    ```
