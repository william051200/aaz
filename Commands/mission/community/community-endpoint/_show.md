# [Command] _mission community community-endpoint show_
...
- CommunityEndpoints_Get
    ```bash
        mission community community-endpoint show --resource-group rgopenapi --community-name TestMyCommunity --community-endpoint-name TestMyCommunityEndpoint
    ```
