# [Command] _mission community transit-hub show_
...
- TransitHub_Get
    ```bash
        mission community transit-hub show --resource-group rgopenapi --community-name TestMyCommunity --transit-hub-name TestThName
    ```
