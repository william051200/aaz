# [Command] _mission virtual-enclave workload show_
...
- Workload_Get
    ```bash
        mission virtual-enclave workload show --resource-group rgopenapi --virtual-enclave-name TestMyEnclave --workload-name TestMyWorkload
    ```
