# [Command] _mission virtual-enclave workload delete_
...
- Workload_Delete
    ```bash
        mission virtual-enclave workload delete --resource-group rgopenapi --virtual-enclave-name TestMyEnclave --workload-name TestMyWorkload
    ```
